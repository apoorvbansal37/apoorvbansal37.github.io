...
docker rm lab-nginx
```
![images for exp 6](./images/image1.png)
![images for exp 6](./images/image2.png)
---
...
services:
  nginx:
    ...
    volumes:
      - ./html:/usr/share/nginx/html
```
![images for exp 6](./images/image3.png)
...
docker compose down
```
![images for exp 6](./images/image4.png)
---
...
docker run -d \
  ...
  wordpress:latest
```
![images for exp 6](./images/image5.png)

Access:

http://localhost:8082

![images for exp 6](./images/image6.png)
...
volumes:
  mysql_data:
```
![images for exp 6](./images/image7.png)
...
```
![images for exp 6](./images/image8.png)
---
...
docker run -d \
  ...
  node:18-alpine
```
![images for exp 6](./images/image9.png)
...
services:
  webapp:
    ...
    restart: unless-stopped
```
![images for exp 6](./images/image10.png)
---
    ...
    deploy:
      resources:
        limits:
          ...
          cpus: '0.5'
```
![images for exp 6](./images/image11.png)
...
```
![images for exp 6](./images/image12.png)
...
CMD ["node", "app.js"]
```
![images for exp 6](./images/image13.png)
...
services:
  nodeapp:
    ...
    ports:
      - "3000:3000"
```
![images for exp 6](./images/image14.png)
...
```
![images for exp 6](./images/image15.png)
---
...
CMD ["node", "app.js"]
```
![images for exp 6](./images/image16.png)
...
services:
  prod-app:
    ...
    environment:
      NODE_ENV: production
```
![images for exp 6](./images/image17.png)
![images for exp 6](./images/image18.png)
![images for exp 6](./images/image19.png)
---
